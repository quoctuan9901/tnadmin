...
define('DIR_PATH',dirname(dirname(dirname(dirname(dirname(dirname(dirname(__DIR__))))))).DS,true);
require DIR_PATH.'bootstrap/autoload.php';
$app = require_once DIR_PATH.'bootstrap/app.php';
...
$config['LicenseName'] = 'QuocTuan.Info';
$config['LicenseKey'] = 'LW6TA44198H6NNX7JFD338D6SGY99LR8';
