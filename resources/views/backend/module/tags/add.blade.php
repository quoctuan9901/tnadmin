...
<form action="" method="POST" accept-charset="utf-8">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Add Tags</h6>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<input type="text" id="name-slug" name="txtTag" class="form-control" placeholder="Please Enter Tags" value="{{ old('txtTag') }}" />
				</div>
				<div class="form-group">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Add Tags English</h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
